      ...
      _c("form", { attrs: { method: "POST", action: "" } }, [
        _c("div", { staticClass: "form-group row" }, [
          _c(
            "label",
            {
              staticClass: "col-md-1 col-form-label text-md-right",
              attrs: { for: "name" }
            },
            [_vm._v("Name")]
          ),
        ...
        _c("div", { staticClass: "form-group row" }, [
          _c(
            ...
            {
              staticClass: "col-md-1 col-form-label text-md-right",
              attrs: { for: "cleaningInstructions" }
            },
            [_vm._v("Cleaning Instructions")]
          ),
          _vm._v(" "),
          _c("div", { staticClass: "col-md-5" }, [
            _c("textarea", { attrs: { name: "cleaningInstructions" } }),
            _vm._v(" "),
            _c(
              "span",
              { staticClass: "invalid-feedback", attrs: { role: "alert" } },
